...
_GUESS_FAMILIES = [
    ...
    ("merge",
     ["strongMergeCandidate", "weakMergeCandidate", "lateF2Candidate",
      "guessMergeClassesC1Candidate", "guessMergeClassesC2Candidate",
      "guessMergeClassesC3Candidate", "guessMergeClassesC4Candidate"],
     [("strongMergeReward",         "strongMergeCandidate"),
      ...
      ("guessMergeClassesC1MergeReward", "guessMergeClassesC1Candidate"),
      ("guessMergeClassesC2MergeReward", "guessMergeClassesC2Candidate"),
      ("guessMergeClassesC3MergeReward", "guessMergeClassesC3Candidate"),
      ("guessMergeClassesC4MergeReward", "guessMergeClassesC4Candidate")]),
    ("composition",
     ["objectInObject"],
