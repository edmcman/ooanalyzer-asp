...
| `possibleVFTableEntry(V, Off, E)` | Entry E at offset Off in vftable V (E may be a thunk) |
...
| `callAtOffset(Caller, Callee, Off)` | Callee is called by Caller with this+Off |
