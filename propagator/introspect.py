...
REWARD_FAMILY = {
    ...
    "guessMergeClassesC1MergeReward": ("c1_merge", 9),
    "guessMergeClassesC2MergeReward": ("c2_merge", 9),
    "guessMergeClassesC3MergeReward": ("c3_merge", 8),
    "guessMergeClassesC4MergeReward": ("c4_merge", 8),
